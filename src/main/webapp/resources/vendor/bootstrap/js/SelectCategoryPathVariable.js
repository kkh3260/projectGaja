...
$(function() {
	$("#concert").click(function() {
	    ...
	    $("#seoul").click(function(){
			var seoul = $("#seoul").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+seoul;
	});
	 // 축제 행사에서 인천 클릭시 이벤트
		$("#incheon").click(function(){
			var incheon = $("#incheon").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+incheon;
	});
		// 축제 행사에서 대전  클릭시 이벤트
		$("#daejeon").click(function(){
			var daejeon = $("#daejeon").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+daejeon;
	});
		// 축제 행사에서 대구  클릭시 이벤트
		$("#daegu").click(function(){
			var daegu = $("#daegu").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+daegu;
	});
		// 축제 행사에서 광주 클릭시 이벤트
		$("#gwangju").click(function(){
			var gwangju = $("#gwangju").attr("name");
		...
		$("#busan").click(function(){
			var busan = $("#busan").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+busan;
	});
		// 축제 행사에서 울산 클릭시 이벤트
		$("#ulsan").click(function(){
			var ulsan = $("#ulsan").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+ulsan;
	});
		// 축제 행사에서 세종특별시  클릭시 이벤트
		$("#sejong").click(function(){
			var sejong = $("#sejong").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+sejong;
	});
		// 축제 행사에서 경기도  클릭시 이벤트
		$("#gyeonggi").click(function(){
			var gyeonggi = $("#gyeonggi").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+gyeonggi;
	});
		// 축제 행사에서 강원도  클릭시 이벤트
		$("#gangwon").click(function(){
			var gangwon = $("#gangwon").attr("name");
			var concert = $("#concert").attr("name");
			location.href="concert/"+concert+"/"+gangwon;
	});
	});
});
